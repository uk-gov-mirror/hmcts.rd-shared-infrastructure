locals {
  ...
  queue_name_1 = "${var.product}-${local.component}-queue-arr-${var.env}"
  queue_name_2 = "${var.product}-${local.component}-queue-2-${var.env}"
